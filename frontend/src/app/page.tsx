...
export default function Home() {
    ...
    return (
        <main className="min-h-screen bg-gray-50 pb-12">
            {/* HERO SECTION COMPACTADO PARA VISIBILIDAD DE CATEGORÍAS ABOVE-THE-FOLD */}
            <section 
                className="relative overflow-hidden bg-gradient-to-r from-[#D94600] via-[#EA580C] to-[#F97316] text-white py-5 lg:py-7"
                ...
                <div className="relative z-10 mx-auto max-w-[1800px] px-4 sm:px-6 lg:px-10">
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-center">
                        ...
                        <div className="lg:col-span-7 space-y-3.5 text-left">
                            ...
                            <p className="text-white/95 text-sm sm:text-base font-medium max-w-xl leading-relaxed">
                            ...
                            <div className="pt-1">
                                <Link 
                                    href="/productos" 
                                    className="inline-flex items-center gap-2 rounded-xl bg-[#0F172A] hover:bg-[#1E293B] px-5 py-2.5 text-sm font-extrabold text-white shadow-lg transition-all hover:scale-105"
                                >
                            ...
                            <div className="pt-3 border-t border-white/20 grid grid-cols-1 sm:grid-cols-3 gap-3 text-xs font-bold">
                                <div className="flex items-center gap-2">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-white/80 text-[0.65rem] font-normal">Calidad garantizada</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-white/80 text-[0.65rem] font-normal">A todo el país</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-white/80 text-[0.65rem] font-normal">Asesoría personalizada</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="lg:col-span-5 flex flex-col items-center justify-center">
                            <div className="w-full bg-white/10 backdrop-blur-md rounded-2xl p-4 border border-white/20 shadow-xl space-y-3">
                                <div className="flex items-center gap-3">
                                    <span className="text-2xl font-black text-white tracking-wider">UBIQUITI</span>
                                </div>
                                <p className="text-xs text-white/90 font-medium">
                                    Tecnología Ubiquiti para redes empresariales de alto rendimiento.
                                </p>
                                <div className="grid grid-cols-4 gap-1.5 pt-1 text-center text-[0.65rem] font-bold">
                                    <div className="bg-blue-500/20 backdrop-blur-xs rounded-xl p-2 flex flex-col items-center gap-1 border border-blue-400/30">
                                    ...
                                    <div className="bg-sky-500/20 backdrop-blur-xs rounded-xl p-2 flex flex-col items-center gap-1 border border-sky-400/30">
                                        <svg className="w-4 h-4 text-sky-300" fill="currentColor" viewBox="0 0 24 24">
                                            <path d="M12 1L3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5l-9-4z" />
                                        </svg>
                                        <span>Seguridad</span>
                                    </div>
                                    <div className="bg-amber-500/20 backdrop-blur-xs rounded-xl p-2 flex flex-col items-center gap-1 border border-amber-400/30">
                                    ...
                                    <div className="bg-orange-500/20 backdrop-blur-xs rounded-xl p-2 flex flex-col items-center gap-1 border border-orange-400/30">
            ...
            {/* BARRA FLOTANTE DE 4 GARANTÍAS (Abajo del Hero - Compactada) */}
            <div className="relative z-20 max-w-[1800px] mx-auto px-4 sm:px-6 lg:px-10 -mt-4">
                <div className="bg-white rounded-2xl py-3 px-5 shadow-lg border border-slate-100 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 divide-y sm:divide-y-0 sm:divide-x divide-slate-100 text-slate-800">
                    {/* Item 1: Productos 100% Originales */}
                    <div className="flex items-center gap-3 pt-1 sm:pt-0 sm:pl-1">
                        <div className="w-9 h-9 rounded-xl bg-orange-50/80 border border-orange-100/50 flex items-center justify-center shrink-0">
                            <svg className="w-4.5 h-4.5 text-[#0284C7]" fill="currentColor" viewBox="0 0 24 24">
                                <path d="M12 1L3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5l-9-4zm-2 16l-4-4 1.41-1.41L10 14.17l6.59-6.59L18 9l-8 8z" />
                            </svg>
                        </div>
                        <div>
                            <h4 className="font-extrabold text-xs text-slate-900 leading-snug">Productos 100% Originales</h4>
                            <p className="text-[0.65rem] text-slate-500 font-medium">Garantía directa con fabricantes</p>
                        </div>
                    </div>

                    {/* Item 2: Mayoristas Autorizados */}
                    <div className="flex items-center gap-3 pt-2 sm:pt-0 sm:pl-4">
                        ...
                        <div>
                            <h4 className="font-extrabold text-xs text-slate-900 leading-snug">Mayoristas Autorizados</h4>
                            <p className="text-[0.65rem] text-slate-500 font-medium">Distribuidores de marcas líderes</p>
                        </div>
                    </div>

                    {/* Item 3: Envíos a Nivel Nacional */}
                    <div className="flex items-center gap-3 pt-2 sm:pt-0 sm:pl-4">
                        <div className="w-9 h-9 rounded-xl bg-orange-50/80 border border-orange-100/50 flex items-center justify-center shrink-0">
                            <svg className="w-4.5 h-4.5 text-[#EA580C]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div>
                            <h4 className="font-extrabold text-xs text-slate-900 leading-snug">Envíos a Nivel Nacional</h4>
                            <p className="text-[0.65rem] text-slate-500 font-medium">Rápidos y seguros</p>
                        </div>
                    </div>

                    {/* Item 4: Asesoría Personalizada */}
                    <div className="flex items-center gap-3 pt-2 sm:pt-0 sm:pl-4">
                        <div className="w-9 h-9 rounded-xl bg-orange-50/80 border border-orange-100/50 flex items-center justify-center shrink-0">
                        ...
                        <div>
                            <h4 className="font-extrabold text-xs text-slate-900 leading-snug">Asesoría Personalizada</h4>
                            <p className="text-[0.65rem] text-slate-500 font-medium">Te ayudamos a elegir lo mejor</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="mx-auto max-w-[1800px] px-4 sm:px-6 lg:px-10 py-3 space-y-5">
