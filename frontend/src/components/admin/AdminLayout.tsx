    ...
    <div className="min-h-screen flex bg-gray-50">
      ...
      <aside className="w-60 bg-[var(--alling-text)] flex flex-col fixed inset-y-0 left-0 z-20">
        <div className="h-16 flex items-center gap-2.5 px-6 border-b border-gray-700">
          ...
          <span className="text-white font-bold text-lg tracking-tight">Alling Admin</span>
        </div>
        ...
        <div className="px-4 py-4 border-t border-gray-700">
          <p className="text-xs text-gray-400 mb-2 truncate">{user?.email ?? "admin"}</p>
          <button
            onClick={logout}
